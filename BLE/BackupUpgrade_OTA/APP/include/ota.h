...
/* IAP定义 */
/* 以下为IAP下载命令定义 */
#define CMD_IAP_WrieBuffer     0x79               // IAP写缓存
...
#define CMD_IAP_PROM_END       0x70               // IAP编程命令结束
#define CMD_IAP_VERIFY_END     0x72               // IAP校验命令结束
...
#define KEY_DATAFLASH_ADD      OTA_DATAFLASH_ADD+256
#define KEY_DATAFLASH_ADD_BAK  (KEY_DATAFLASH_ADD + EEPROM_PAGE_SIZE)
#define NFC_DATAFLASH_ADD      (KEY_DATAFLASH_ADD_BAK + EEPROM_PAGE_SIZE)
