...
@set CUSTOMER=1
@set EPAPER_TYPE=ENABLE_INK_SCREEN_JD79686BB_800X480_COLOR_3
...
@set U_FACTORY=TDX
@set U_CUSTOMER=TDX
@set U_EPAPER_TYPE_DIR=XT_JD_800X400C3
::########################
...
for %%t in (%EPD_SCREEN_TYPE%) do (
	...
	if "!EPD_SCREEN_TYPE_TMP!"=="EPD_SCREEN_TYPE_A" (
        @set U_EPAPER_TYPE=XT_JD_800X400C3_A
    ) else (
        @set U_EPAPER_TYPE=XT_JD_800X400C3_T
    )    
