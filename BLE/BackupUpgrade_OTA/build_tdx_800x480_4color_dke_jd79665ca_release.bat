...
@set CUSTOMER=1
@set EPAPER_TYPE=ENABLE_INK_SCREEN_JD79665CA_800X480_COLOR_4
...
@set U_FACTORY=TDX
@set U_CUSTOMER=TDX
@set U_EPAPER_TYPE_DIR=DKE_JD79665CA_800X480C4
::########################
...
for %%t in (%EPD_SCREEN_TYPE%) do (
	...
	if "!EPD_SCREEN_TYPE_TMP!"=="EPD_SCREEN_TYPE_A" (
        @set U_EPAPER_TYPE=DKE_JD79665CA_800X480C4_A
    ) else (
        @set U_EPAPER_TYPE=DKE_JD79665CA_800X480C4_T
    )
	...
	@echo /************************************************************/
	@echo Build TDX DKE JD79665CA 800x480 4color Project
	@echo VER:			!VER_TMP!
