...
@set CUSTOMER=1
@set EPAPER_TYPE=ENABLE_INK_SCREEN_UC8579_1360X480_COLOR_4
...
@set U_FACTORY=TDX
@set U_CUSTOMER=TDX
@set U_EPAPER_TYPE_DIR=DKE_UC8579_1360X480C4
::########################
...
for %%t in (%EPD_SCREEN_TYPE%) do (
	...
	if "!EPD_SCREEN_TYPE_TMP!"=="EPD_SCREEN_TYPE_A" (
        @set U_EPAPER_TYPE=DKE_UC8579_1360X480C4_A
    ) else (
        @set U_EPAPER_TYPE=DKE_UC8579_1360X480C4_T
    )    
	...
	@echo /************************************************************/
	@echo Build TDX DKE UC8579 1360x480 4color Project
	@echo VER:			!VER_TMP!
