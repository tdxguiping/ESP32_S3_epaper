...
@set CUSTOMER=1
@set EPAPER_TYPE=ENABLE_INK_SCREEN_JD79668A_400X300_COLOR_4
...
@set U_FACTORY=TDX
@set U_CUSTOMER=TDX
@set U_EPAPER_TYPE_DIR=XT_JD_400X300C4
::########################
...
for %%t in (%EPD_SCREEN_TYPE%) do (
	...
	if "!EPD_SCREEN_TYPE_TMP!"=="EPD_SCREEN_TYPE_A" (
        @set U_EPAPER_TYPE=XT_JD_400X300C4_A
    ) else (
        @set U_EPAPER_TYPE=XT_JD_400X300C4_T
    )    
