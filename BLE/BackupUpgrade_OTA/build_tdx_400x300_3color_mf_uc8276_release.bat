...
@set CUSTOMER=1
@set EPAPER_TYPE=ENABLE_INK_SCREEN_UC8276_400X300_COLOR_3
...
@set U_FACTORY=TDX
@set U_CUSTOMER=TDX
@set U_EPAPER_TYPE_DIR=MF_UC_400X300C3
::########################
...
for %%t in (%EPD_SCREEN_TYPE%) do (
	...
	if "!EPD_SCREEN_TYPE_TMP!"=="EPD_SCREEN_TYPE_A" (
        @set U_EPAPER_TYPE=MF_UC_400X300C3_A
    ) else (
        @set U_EPAPER_TYPE=MF_UC_400X300C3_T
    )    
