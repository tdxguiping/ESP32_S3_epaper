...
@set USER_CFLAGS=-DVER=%VER% -D%FACTORY% -DINK_SCREEN_CUSTOMER=%CUSTOMER% -D%EPAPER_TYPE% -D%FLASH_MODE% -DINK_DEVICE_CHIP=INK_CHIP_CH585 -DEPD_SCREEN_TYPE_T
::########################

::#########USER mkdir dir and file#########
@set U_FACTORY=TDX
@set U_CUSTOMER=TDX
@set U_EPAPER_TYPE=YT_SPD_800X400C6
::########################
