...
@set CUSTOMER=1
@set EPAPER_TYPE=ENABLE_INK_SCREEN_JD79665_800X480_COLOR_4
@set FLASH_MODE=USB_EXTERN_FLASH_SAVE
@set BATTERY=HARDWAR_DRY_CELL
@set USER_CFLAGS=-DVER=%VER% -D%FACTORY% -DINK_SCREEN_CUSTOMER=%CUSTOMER% -D%EPAPER_TYPE% -D%FLASH_MODE% -D%BATTERY% -DINK_DEVICE_CHIP=INK_CHIP_CH585
::########################

::#########USER mkdir dir and file#########
@set U_FACTORY=TDX
@set U_CUSTOMER=TDX
@set U_EPAPER_TYPE=XT_JD_800X400C4_DRY_CELL
::########################
