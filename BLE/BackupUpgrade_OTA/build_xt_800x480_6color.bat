...
::#########DEFINE#########
@set VER=V%VER_TMP%
@set FACTORY=ENABLE_SOFTWARE_TO_XT
@set CUSTOMER=1
@set EPAPER_TYPE=ENABLE_INK_SCREEN_EL073TF1_400X600_COLOR_6
...
@set U_FACTORY=xt
@set U_CUSTOMER=tdx
@set U_EPAPER_TYPE=400X600_color6
@set U_FLASH_MODE=extern_flash
::########################

@set DEST_DIR_NAME=%U_FACTORY%_%U_EPAPER_TYPE%_%U_FLASH_MODE%
