...
// TDX WiFi passthrough mode: BLE write -> wake WiFi on PA0 -> UART1 115200.
// In this mode image refresh/storage/broadcast switching flows are disabled.
#define ENABLE_WIFI_UART1_PASSTHROUGH
// NFC circuit is not populated on this CH585 board revision.
// #define ENABLE_APP_NFC

#ifdef ENABLE_WIFI_UART1_PASSTHROUGH
#define DISABLE_EPD_IMAGE_FEATURES
#define DISABLE_USER_LOCK_FEATURE
#endif

// UART1 official example isolation test.
// When enabled, firmware only runs UART1 PA8/PA9 interrupt echo test and skips BLE/WiFi business.
// #define ENABLE_UART1_OFFICIAL_EXAMPLE_TEST
...
#define ENABLE_SCREEN_COLOR_3
	...
	(defined(ENABLE_INK_SCREEN_SSD2683ZA_272X792_COLOR_4))
...
// �ڰ�ͼƬ�ֲ����ԣ�����ض��ĺڰ��ֲ��������뺯��EPD_3C_BWSolidImg_CycleTest��Ӧ��
...
#define  WIFI_WAKE_KEY                      GPIO_Pin_2    // PB2, active low wake key for WiFi

#define ADC_TASK_PERIOD_SECONDS             2UL
#define ADC_TASK_PERIOD_TMOS_TICKS          (ADC_TASK_PERIOD_SECONDS * 1600UL)
/* Define ENABLE_BATTERY_ADC_TEST_INTERVAL only when testing ADC periodic refresh. */
// #define ENABLE_BATTERY_ADC_TEST_INTERVAL
...
#define   EVENT_UART1_WIFI_RX           	(0x8000)

#define   _Ble_Picture_TimeOut           	(61999)

// small inter 20ms
#define DEFAULT_ADVERTISING_INTERVAL   		800//1400//1200//(1.0*1600)//(1.0*1600)//260  //200ms
#define DEFAULT_ADVERTISING_INTERVAL_Max    800//1400//1200//(1.0*1600)//(1.0*1600)//1600     //1.5s
